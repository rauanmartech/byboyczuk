  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-col-reverse sm:flex-row gap-4 pt-6">
        <Button type="button" variant="outline" onClick={prevStep} className="w-full sm:w-auto py-6 px-8 rounded-2xl border-2 flex items-center justify-center gap-2">
          <ArrowLeft size={20} />
          <span className="sm:hidden">Voltar</span>
        </Button>
        <Button type="submit" className="w-full sm:flex-1 py-6 text-lg rounded-2xl shadow-lg bg-primary hover:bg-primary/90 text-primary-foreground">
